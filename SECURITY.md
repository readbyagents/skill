...
Please email **security@readbyagents.com** with:
- A description of the issue
- Steps to reproduce (if applicable)
- Your GitHub handle for credit (optional)

**Response time**: within 72 hours. We will coordinate a fix and disclosure timeline with you before any public write-up.
